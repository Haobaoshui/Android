...
class MainActivity : ComponentActivity() {
    ...
    private fun insertData() {
        ...
        //简单起见，这里仅仅增加固定姓名的用户。注意，由于主键为自增型，因此每个用户是不同的记录.
        // 表中记录可以通过菜单View->Tool Windows->App inspecation查看
        val user = User(userName = "a", userPassword = "123", userEmail = "a@a.com", modifyDate = Date())
    ...
    private fun deleteData() {
        ...
        //传入主键，这里删除主键为1的记录
        val user = User(uid = 1, userName = "a", userPassword = "123", userEmail = "a@a.com", modifyDate = Date())
        val userDao = db.userDao()
    ...
    private fun updateData() {
        ...
        //修改主键为2的记录
        val user = User(uid = 2, userName = "b", userPassword = "456", userEmail = "b@a.com",modifyDate = Date())
        val userDao = db.userDao()
